...
def calc_log_polar_descriptor(gradient,angle,x,y,scale,main_angle,d,n):
    ...
    M,N = gradient.shape
    radius = int(round(min(48*scale,min(M/3,N/3))))
    if x >= N or y >= M:
        print('out of size')
